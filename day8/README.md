...
I ran through 1000 distances, sorted by shortest, adding each of the pair of points to sets as I went. If neither were in a set, a new set was made. If one was in a set, the other was added to the pre-existing set, and if both were in different sets, the sets were merged.
